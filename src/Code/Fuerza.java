...
public class Fuerza extends Ejercicios {
	...
	public void RutinaPrincipiante(boolean usarMaquinas) {
	...
	public void RutinaIntermedia(boolean usarMaquina) {
		String respuesta = JOptionPane.showInputDialog(null, "¿Quiere usar maquina?(SI/NO");
		String mensaje = "";
		if (respuesta.equalsIgnoreCase("SI")) {
			usarMaquinas = true;
			// if (nivel.equalsIgnoreCase("intermedia")) {
	...
	public void RutinaAvanzada(boolean usarMaquina) {
		String respuesta = JOptionPane.showInputDialog(null, "¿Quiere usar maquina?(SI/NO");
		String mensaje = "";
		if (respuesta.equalsIgnoreCase("SI")) {
			usarMaquinas = true;
			// if (nivel.equalsIgnoreCase("Avanzada")) {
